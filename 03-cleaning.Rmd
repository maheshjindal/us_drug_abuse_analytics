...
save(tedsa_puf_2000_2019, file = "tedsa_puf_2000_2019_final_cleaned.RData")
...
population_data <- read.csv("sc-est2019-alldata5.csv")
```
...
population_data1 <- read.csv("/Users/mridulgupta/Downloads/sc-est2010-alldata5.csv")
