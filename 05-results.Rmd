...
ggplot(
  ...
  aes(x = STFIPS , y = Proportion_of_cases, fill = GENDER)
             ...
             width = .6,
             position = "dodge")   +
  coord_flip() +  theme_bw() + facet_wrap( ~ ADMYR) + ylab("States")+xlab("Proportion of cases")+ggtitle("Proportion of admission for each gender and sate facted by years") + labs(subtitle = 'Substance: Heroin') + theme(legend.position="top")
